...
class DBHelper extends SQLiteOpenHelper {
    ...
    // 1) onCreate - creates all needed tables
    @Override
    ...
    // 2) onUpgrade - called when database structure (schema) is changed
    @Override
    ...
    public List<Task> getAllTasks() {
        ...
        // Cursor stores teh results of a query
        ...
        if (cursor.moveToFirst()) {
            ...
            do {
                // This produces a task with it's place in the column (primary key / id = 0)
    ...
    /**
     * This allows a value to be edited in the database,
     * it searches
     *
     * @param taskToEdit
     */
