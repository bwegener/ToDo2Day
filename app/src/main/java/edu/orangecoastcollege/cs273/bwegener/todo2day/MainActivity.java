...
/**
 * This is the MainActivity that starts when the app is first launched.
 * It creates and connects the database to the app.
 *
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAllTasksList.add(new Task("Don't study for CS 273 Midterm", true));
        mAllTasksList.add(new Task("Study a little for CS 273 Midterm", false));
        mAllTasksList.add(new Task("Never study for CS 273 Midterm", true));
